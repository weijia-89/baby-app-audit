...
2. Baby+ About You picture and capture are done (2026-08-21). Force-upgrade still blocks home. Re-scan older `.mitm` files if you need request-body verdicts from before the HAR `postData` fix.
